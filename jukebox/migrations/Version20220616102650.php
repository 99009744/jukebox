 ...
 */
final class Version20220616102650 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(180) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP email, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
